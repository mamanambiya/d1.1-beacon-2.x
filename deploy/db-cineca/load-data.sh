...
echo "To load initial data use the db-cineca/data/insert_child.py script"
echo "Move to db-cineca/data and do 'python3 ./insert_child.py --vcffile child.vcf fake_child.json'"